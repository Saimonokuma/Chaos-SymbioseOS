...
NTSTATUS BootParams_Init(_Out_ PBOOT_PARAMS BootParams, _In_ PVOID KernelBuffer,
                         _In_ SIZE_T KernelSize, _In_ PVOID RamdiskBuffer,
                         _In_ SIZE_T RamdiskSize);

NTSTATUS BootParams_SetCommandLine(_Inout_ PBOOT_PARAMS BootParams,
                                   _In_ PCSTR CommandLine);

NTSTATUS BootParams_PatchKernelZeroPage(_Inout_ PBOOT_PARAMS BootParams);
