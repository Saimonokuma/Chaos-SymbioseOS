...
SwitchToChaosKernel:
	...
	; ============================================================
	mov rax, r10			; BootParams
	mov rax, [rax + BOOT_PARAMS_PML4_OFFSET]		; hdr.cmdline_ptr or PML4 address
...
; ============================================================
	; Phase 6: Load 32-bit Compatibility Code Segment
	...
	push 0x10
	lea rax, [rel compat_mode_entry]
	push rax
	retfq

global compat_mode_entry
compat_mode_entry:
	[BITS 32]

	; ============================================================
	; Phase 7: Disable Paging (PG bit 0 in CR0)
	; ============================================================
	mov eax, cr0
	btr eax, 31		; Clear PG bit (bit 31)
	mov cr0, eax

	; ============================================================
	; Phase 8: Clear LME bit (IA32_EFER.LME, bit 8)
	; ============================================================
	...
	; Standard Linux kernel load address
	jmp eax
